...
class ChamalSales extends Component {
    state = { sales:[{
        ...
        return ( <div style={{flex:1}} >
            <BootstrapTable data={ this.state.sales } options={this.options} insertRow={ true } hover condensed 
              ...
              bodyStyle={ { border: 'green 1px solid' } }>
                ...
                <TableHeaderColumn dataField='date' editable={ { type: 'datetime' } } width={140} dataSort={true} filter={{type:'TextFilter',delay:1000}} >Date</TableHeaderColumn>
